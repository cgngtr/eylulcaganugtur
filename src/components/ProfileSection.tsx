...
const ProfileSection = () => {
  return (
    <div className="rounded-lg border bg-card text-card-foreground shadow-sm overflow-hidden relative">
      ...
      <div className="p-6 pt-0 mt-5 relative z-10">
        <div className="flex flex-row items-center">
          <div className="relative group">
            ...
            <img 
              ...
              alt="Profile" 
              className="rounded-2xl w-[100px] h-[100px] relative transition-all duration-300 group-hover:scale-105 z-10"
            />
          </div>
          <div className="ml-4 flex flex-col gap-y-1">
            ...
            <h1 className="text-2xl font-bold text-primary">Çağan</h1>
        ...
        <div className="mt-5 flex max-w-[50vh] flex-wrap gap-2 rounded-xl bg-background/80 backdrop-blur-sm p-3 shadow-inner">
        ...
        <div className="mt-5 flex flex-row items-center gap-2">
          <Button className="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-primary text-primary-foreground hover:bg-primary/90 h-10 px-4 py-2 w-full gap-1 relative overflow-hidden group">
            {/* Add hover effect */}
          ...
          <Button className="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-secondary text-secondary-foreground hover:bg-secondary/80 h-10 px-4 py-2 w-full gap-2 relative overflow-hidden group">
            {/* Add hover effect */}
