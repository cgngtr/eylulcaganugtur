...
const ProcessStep = ({ number, title, description, icon }: ProcessStepProps) => {
  return (
    <div className="rounded-lg border text-card-foreground shadow-sm group h-fit overflow-hidden bg-background">
      <div className="relative flex flex-row gap-4 p-3 transition-all duration-300">
        ...
        <div className="flex flex-col gap-1 transition-all duration-300 md:group-hover:translate-x-3 min-h-[60px] flex-grow">
      ...
      <div className="p-6 pt-0">
        <div className="grid grid-cols-1 gap-4">
          <ProcessStep
            ...
            icon={<Users className="size-10 text-primary" fill="currentColor" />}
          />
          ...
          <ProcessStep
            ...
            icon={<Code2 className="size-10 text-primary" fill="currentColor" />}
          />
          ...
          <ProcessStep
            ...
            icon={<FlaskConical className="size-10 text-primary" fill="currentColor" />}
          />
          ...
          <ProcessStep
            ...
            icon={<Rocket className="size-10 text-primary" fill="currentColor" />}
          />
        </div>
      </div>
    </div>
